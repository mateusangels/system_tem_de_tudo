...
const PDV = () => {
  ...
  return (
    <div className="h-screen flex flex-col text-white overflow-hidden relative" style={{ background: 'linear-gradient(135deg, #1a1a1a 0%, #2a2a2a 30%, #1f1f1f 60%, #0f0f0f 100%)' }}>
      ...
      {/* TOP BAR */}
      <header className="relative z-20 flex items-center justify-between px-4 py-2 bg-black border-b border-zinc-800 shadow-lg">
        <div className="flex items-center gap-3">
          <button onClick={() => navigate('/produtos')} className="p-1 rounded-lg hover:bg-white/10 transition-colors">
